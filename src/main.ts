...
import { CityEntity, CityModel } from './modules/cities/cities.entity.js';
...
RESTAppContainer.bind<types.ModelType<CityEntity>>(RESTAppComponent.CityModel).toConstantValue(CityModel);
RESTAppContainer.bind<CitiesDBServiceInterface>(RESTAppComponent.CitiesDBServiceInterface).to(CitiesDBService);
