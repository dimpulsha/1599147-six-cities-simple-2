...
export default class CommentsController extends Controller {
  ...
  constructor(
    ...
    this.addRoute({path: '/:offerId', method: HttpMethod.Get, handler: this.getByOfferId});
  }
  ...
  public async getByOfferId({ params, query }: Request<core.ParamsDictionary | ParamsGetOffer, Record<string, unknown>, Record<string, unknown>, RequestQuery>, res: Response): Promise<void> {
