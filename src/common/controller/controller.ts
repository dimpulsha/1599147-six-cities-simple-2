...
import { getFullServerPath, transformObject } from '../../utils/common-utils.js';
import { UnknownObject } from '../../types/unknown-object.type.js';
import { STATIC_RESOURCE_FIELDS } from '../../app.config.js';
...
export abstract class Controller implements ControllerInterface {
  ...
  protected addStaticPath(data: UnknownObject): void {
    const fullServerPath = getFullServerPath(this.configService.getItem('HOST'), this.configService.getItem('PORT'));
    transformObject(
      STATIC_RESOURCE_FIELDS,
      `${fullServerPath}/${this.configService.getItem('STATIC_DIRECTORY')}`,
      `${fullServerPath}/${this.configService.getItem('UPLOAD_DIRECTORY')}`,
      data
    );
  }
